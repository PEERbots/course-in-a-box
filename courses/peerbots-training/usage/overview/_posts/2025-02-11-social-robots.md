...
Here are some examples of social robots in the more academic sense:

- Peerbots Backpack
  <img src="/img/peerbot-backpack.webp" alt="A backpack with a robot face. The backpack has a clear screen and behind it there is an iPad showing the robot face." width="200px">

  - Misty Robot
    <img src="/img/misty.jpg" alt="A Misty robot." width="200px">

  - Furhat Robot
    <img src="/img/furhat.jpg" alt="A Furhat robot." width="200px">

## What can they do?

Social robots mostly just talk but they can also move around and gesture as a way to communicate socially as well. But by talking, they can accomplish so much by connecting with people, educating, helping, or entertaining them.

Check out the next submodule to see how you can access all that.
